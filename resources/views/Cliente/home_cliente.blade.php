...
<section id="dashboard">
    ...
    <div class="metrics-grid">
        <div class="metric-card">
            <span class="tag">Sensor 01</span>
            <div class="metric-label">Umidade do Solo</div>
            <div class="metric-value" id="val-umidade">65%</div>
            <p>Status: <strong style="color: var(--secondary-color);">Ideal</strong></p>
        </div>
        ...
        <div class="metric-card">
            ...
            <p>Previsão de colheita: 7 dias</p>
        </div>
        ...
        <div class="metric-card profit-card">
            ...
            <div class="metric-value">R$ 342,00</div>
